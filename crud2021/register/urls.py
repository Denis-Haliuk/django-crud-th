...
urlpatterns = [
    ...
    path('spec_list/spec_upload/', views.spec_upload, name='spec_upload'),
    ...
    path('groups_list/groups_upload/', views.groups_upload, name='groups_upload'),
    ...
    path('predmety_list/predmety_upload/', views.predmety_upload, name='predmety_upload'),
    ...
    path('itog_list/itog_upload/', views.itog_upload, name='itog_upload'),
